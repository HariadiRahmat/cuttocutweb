...
export default function Pricing() {
  ...
  const getWaLinkWithText = (planName: string, priceText: string) => {
    const text = encodeURIComponent(
      `Halo CuttucutApp, saya tertarik untuk berkonsultasi mengenai pembangunan sistem digital dengan sistem *Paket ${planName} (${priceText})* untuk bisnis Coffee Shop saya.`
    );
